package com.doublestring.codechef;
...
class Writer {
	...
	private FileOutputStream getFileOutputStream(PrintStream out) {
		try {
			...
			if (os instanceof BufferedOutputStream) {
				...
				field = bos.getClass().getSuperclass()
						.getDeclaredField("out");
				field.setAccessible(true);
	...
	private final int[] boundaries = new int[] { 9, 99, 999, 9999,
			99999, 999999, 9999999, 99999999, 999999999 };
	private final int[] divs = new int[] { 1, 10, 100, 1000, 10000,
