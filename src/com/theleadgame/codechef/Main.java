package com.theleadgame.codechef;
...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		int leadPlayer = 0, maxScore = 0;
		
		int score1 = 0, score2 = 0, a= 0, b = 0;
		...
		for(; 0 < inputLength--; ){
			...
			if(score1 - score2 > maxScore){
				...
				leadPlayer = 1;
			}else if(score2 - score1 > maxScore){
		...
		//final output
		System.out.println(leadPlayer+ " " + maxScore);
